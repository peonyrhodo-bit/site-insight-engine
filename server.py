...
@app.get("/test/data-layer")
async def test_data_layer():

    query = youtube_data.add_query(
        YouTubeQuery(
            query_id=9001,
            text="тестовая тема",
            language="ru",
    ...
    video = youtube_data.add_video(
        YouTubeVideo(
            video_id=9001,
            youtube_id="test-video-9001",
            title="Тестовое видео",
        )
    )

    snapshot = youtube_data.add_snapshot(
        YouTubeSnapshot(
            snapshot_id=9001,
            video_id=9001,
            metrics={
    ...
    research_sets.add_query(
        research.research_id,
        9001,
    )

    research_sets.add_video(
        research.research_id,
        9001,
    )

    research_sets.add_snapshot(
        research.research_id,
        9001,
    )
